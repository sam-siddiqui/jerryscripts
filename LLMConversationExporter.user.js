...
Answer concisely and accurately.
  ...
  function toggleModal() {
    console.log("[ContextManager]: 0. Toggled Modal");
    const modal = document.getElementById('gemini-ctx-modal');
    const isHidden = modal.style.display === 'none';
    console.log("[ContextManager]: 1. Toggled Modal");
    if (isHidden) {
      // Load current values from Storage before showing
      console.log("[ContextManager]: 2. Toggled Modal");
      ...
      console.log("[ContextManager]: 3. Toggled Modal");
      // Trigger input event to update counter
      document.getElementById('ctx-system-input').dispatchEvent(new Event('input'));
      console.log("[ContextManager]: 4. Toggled Modal");

      modal.style.display = 'block';
      console.log("[ContextManager]: 10. Toggled Modal");
    } else {
